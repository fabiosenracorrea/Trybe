...
The first project of Trybe's 9th module.
...
This project got a **100%/100%** grade and can be checkout entirely on [here](https://github.com/tryber/sd-06-project-shopping-cart/pull/64).
...
As such, understanding how to deal with Promises and API calls is mandatory. This project was great for understanding better how to think of a logic when it comes to building a website that handles user interaction with API products to create (and save) a working shopping cart.

Because of the automated constraints when it comes to the grading of this project, the design choices here were predefined. As such, the main focus on this project is on the logic to make everything work.
