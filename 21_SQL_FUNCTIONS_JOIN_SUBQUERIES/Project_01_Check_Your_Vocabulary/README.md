## Project 01 - SQL: Check your vocabulary!

The first project of Trybe's 21th module, centered around basic SQL skills and queries.
...
This project got a **100%/100%** grade and can be checkout entirely on [here](https://github.com/tryber/sd-06-mysql-vocabulary-booster/pull/34).
