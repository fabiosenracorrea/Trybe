...
This project got a **100%/100%** grade and can be checkout entirely on [here](https://github.com/tryber/sd-06-mongodb-dataflights/pull/66).


#### Comments

MongoDB is the most popular noSQL database out there. It's even more popular than some of 'classic' SQL options. And, because of that, knowing how to properly query and find simple information should be no problem to any developer.

On the next module, we will be diving into more complex queries, which is where the fun starts. Stay tunned!
