...
> *Note: modifications of my own were added to the existing code to better reflect a more modern server creation, with modules and classes.*
...
2. Adicione o script do nodemon
