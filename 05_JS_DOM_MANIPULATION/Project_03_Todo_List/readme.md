...
Because of the constraints of the project, i had to leave some content directly on HTML, as they are here, on this version. But as i experiment more on the page, more diverged from the actual project page it will became.

The most interesting feature that i added was a user interface that shows account options, as it would normally on a logged in application.

The color palette of choice needs a revamp, but the usability of it is pretty good for a 2-day project (so far). Any update, if it exists, will be written below.
