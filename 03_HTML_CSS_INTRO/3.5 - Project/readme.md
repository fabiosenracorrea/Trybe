...
The main goal here was to design a static webpage using each and every format and specification given.
...
The most interesting feature i developed here was the semantic HTML struture, shown below:

![Semantic HTML shown with divs](images/semantic_with_divs.png)

Why? Because it was entirely constructed with <divs> and CSS! It's the perfect example of how much i've learned on the box model and how to manipulate it as i wish using CSS.
