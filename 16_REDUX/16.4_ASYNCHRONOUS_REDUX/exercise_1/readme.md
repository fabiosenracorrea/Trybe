## Exercise 1: Use Middleware to Handle Asynchronous Actions
...
This is an exercise from FreeCodeCamp. Link [here](https://www.freecodecamp.org/learn/front-end-libraries/redux/use-middleware-to-handle-asynchronous-actions)
