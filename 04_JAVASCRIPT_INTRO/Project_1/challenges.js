...
// Desafio 6 - Outro approach - menos interação
function highestCount2(arr) {
  arr.sort((a, b) => b - a);
  let higher = arr[0];
  for (let i = 0; i < arr.length; i += 1) { //desse jeito não precisamos percorrer o array denovo depois de sortar
    if (higher !== arr[i]) {
      return i
    }
  }
