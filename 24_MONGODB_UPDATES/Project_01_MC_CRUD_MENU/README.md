...
This project got a **100%/100%** grade and can be checkout entirely on [here](https://github.com/tryber/sd-06-mongodb-commerce/pull/51).


#### Comments

As we interact more with different collections on MongoDB, more complex operations to find what we want become needed. This project covers really well a lot of great operators to make sure the right document is found/updated.
