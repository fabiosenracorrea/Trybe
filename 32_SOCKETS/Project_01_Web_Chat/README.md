## Project 01 - NodeJS: WebSockets & Chat API

The first project of Trybe's 32st module, in which we check the traditional MVP architecture alongside sockets and the popular socket.io framework.
...
This project got a **100%/100%** grade and can be checkout entirely on [here](https://github.com/tryber/sd-06-project-webchat/pull/48).

#### Comments

WebSockets are awesome, and digging deeper on how to create a proper webchat is nice on a lot of applications.
